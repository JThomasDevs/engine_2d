use crate::render::text::{Text, TextAlign, TextRenderer};
...
impl<'a> FluentTextBuilder<'a> {
    fn new(renderer: &'a mut SimpleTextRenderer, font_name: String) -> Self {
        let font = renderer.fonts.get(&font_name).cloned().unwrap_or_else(|| {
...
impl SimpleTextRenderer {
    ...
    pub fn new(
        gl: Rc<crate::render::gl_wrapper::GlWrapper>,
    ...
    fn calculate_anchor_offset(&self, text: &str, config: &TextConfig) -> Result<Vec2, String> {
        ...
        let scale_factor = self
            .text_renderer
            .viewport
            .calculate_scale_factor(config.size as f32);
    ...
    fn calculate_anchor_offset_viewport(
        &self,
        text: &str,
        config: &TextConfig,
        viewport_pos: Vec2,
    ...
    fn calculate_text_width(
        &self,
        text: &str,
        font: &crate::render::text::FontInfo,
        scale_factor: f32,
    ) -> f32 {
        let mut width = 0.0;
    ...
    pub fn draw_text_fluent(
        ...
        let viewport_pos = self
            .text_renderer
            .viewport
            .top_left_to_viewport(Vec2::new(x, y));
    ...
    pub fn draw_text_sized(
        ...
        let viewport_pos = self
            .text_renderer
            .viewport
            .top_left_to_viewport(top_left_pos);
    ...
    /// Uses top-left coordinate system (0,0 = top-left, positive Y goes down)
    pub fn draw_text_colored_sized(
        &mut self,
        text: &str,
        x: f32,
        y: f32,
    ...
    /// Uses top-left coordinate system (0,0 = top-left, positive Y goes down)
    pub fn draw_text_centered_sized(
        &mut self,
        text: &str,
        x: f32,
        y: f32,
    ...
    pub fn set_coordinate_range(&mut self, x_min: f32, x_max: f32, y_min: f32, y_max: f32) {
        self.text_renderer
            .set_coordinate_range(x_min, x_max, y_min, y_max);
    }
    ...
    pub fn set_viewport_independent_text(&mut self, independent: bool) {
        self.text_renderer
            .viewport_mut()
            .set_viewport_independent_text(independent);
    }
    ...
    pub fn draw_text_colored_top_left(
        &mut self,
        text: &str,
        x: f32,
        y: f32,
    ...
    /// * `font_path` - Path to the font file
    /// * `size` - Font size in pixels
    pub fn draw_text_centered_top_left(
        &mut self,
        text: &str,
        x: f32,
        y: f32,
    ...
    pub fn draw_text_wrapped_top_left(
        &mut self,
        text: &str,
        x: f32,
        y: f32,
        ...
        let mut text_obj =
            super::text::Text::new(text.to_string(), viewport_pos, font_name.to_string());
    ...
    pub fn draw_text_ellipsis_top_left(
        &mut self,
        text: &str,
        x: f32,
        y: f32,
