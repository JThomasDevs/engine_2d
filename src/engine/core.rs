...
impl Engine {
    pub fn new() -> Result<Self, Box<dyn std::error::Error>> {
        Self::new_with_config_and_animation(
            ...
            Box::new(crate::animation::NoAnimation::new()),
        )
    }
    ...
    #[cfg(feature = "opengl")]
    pub fn new_with_config_and_animation(
        config: EngineConfig,
        animation: Box<dyn Animation>,
        ...
        let mut text_renderer =
            SimpleTextRenderer::new(Rc::clone(&gl_wrapper_rc), config.fallback_font_path.clone())?;
        ...
        if let Err(e) = text_renderer
            .viewport_mut()
            .set_text_height_fraction(viewport_config.text_height_fraction)
        {
        ...
        if let Err(e) = text_renderer
            .viewport_mut()
            .set_base_font_size(viewport_config.base_font_size)
        {
